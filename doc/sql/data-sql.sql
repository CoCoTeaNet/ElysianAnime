-- 用户数据
INSERT INTO elysiananime.sys_user (id,username,nickname,password,sex,email,mobile_phone,account_status,avatar,last_login_ip,last_login_time,create_by,create_time,update_by,update_time,is_deleted,revision) VALUES
	 (2233,'admin','admin','E10ADC3949BA59ABBE56E057F20F883E',1,NULL,NULL,1,NULL,'0:0:0:0:0:0:0:1','2024-08-29 10:32:49',2233,'2024-08-29 10:17:26',2233,'2024-08-29 10:32:49',0,NULL);

-- 角色数据
INSERT INTO elysiananime.sys_role (id,role_name,role_key,remark,sort,create_by,create_time,update_by,update_time,is_deleted,revision) VALUES
	 (2211231231,'超级管理员','role:super:admin',NULL,1,2233,'2024-08-29 10:21:31',2233,'2024-08-29 10:21:34',0,NULL),
	 (1278670599241994240,'订阅者','bangumi:rss:subscriber',NULL,1,2233,'2024-08-29 11:00:27',2233,'2024-08-29 11:00:27',0,NULL);

-- 菜单数据
INSERT INTO elysiananime.sys_menu (id,menu_name,permission_code,router_path,parent_id,menu_type,is_menu,menu_status,component_path,is_external_link,icon_path,sort,create_by,create_time,update_by,update_time,is_deleted,revision) VALUES
	 (1111,'菜单管理','','/admin/sys-menu-manager',1278666636891394048,1,1,0,'',0,'Menu',1,2233,'2024-08-29 10:20:54',2233,'2024-08-29 10:45:31',0,NULL),
...
-- 字典数据
INSERT INTO elysiananime.sys_dictionary (id,parent_id,dictionary_name,remark,sort,enable_status,create_by,create_time,update_by,update_time,is_deleted,revision) VALUES
	 (19999,0,'RSS排除方案','配置一些常见的排除规则，如：01-12,V2,繁体内封',0,1,2233,'2024-10-30 11:36:24',2233,'2024-10-30 11:36:24',0,NULL);

-- 用户角色关联数据
INSERT INTO elysiananime.sys_user_role (id,user_id,role_id) VALUES
	 (1122,2233,2211231231);

-- 角色菜单关联数据
INSERT INTO elysiananime.sys_role_menu (id,role_id,menu_id) VALUES
	 (1278670365086584832,2211231231,1278666070165426176),
