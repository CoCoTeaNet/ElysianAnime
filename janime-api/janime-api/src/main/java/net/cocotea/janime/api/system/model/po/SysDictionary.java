...
/*---begin-auto-generate-don't-update-this-area--*/	
	...
	@Column(name="id",comment="字典id",length=19L,type=java.sql.Types.BIGINT,nativeType="BIGINT",nullable=false)
	private BigInteger id;

	@Column(name="parent_id",comment="父级id",length=19L,type=java.sql.Types.BIGINT,nativeType="BIGINT",nullable=true)
	private BigInteger parentId;

	@Column(name="dictionary_name",comment="字典名称",length=30L,type=java.sql.Types.VARCHAR,nativeType="VARCHAR",nullable=false)
	private String dictionaryName;

	@Column(name="remark",comment="备注",length=255L,type=java.sql.Types.VARCHAR,nativeType="VARCHAR",nullable=true)
	private String remark;

	@Column(name="sort",comment="排序号",length=10L,type=java.sql.Types.INTEGER,nativeType="INT",nullable=false)
	private Integer sort;

	@Column(name="enable_status",comment="启用状态;0关闭 1启用",length=3L,defaultValue="1",type=java.sql.Types.TINYINT,nativeType="TINYINT",nullable=true)
